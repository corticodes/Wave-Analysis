...
%           MUST BE DEVISOR OF 360. Default is 10 degrees.
%       plotRaster: 
...
%   Output:
%   neuronFiringPhaseRate is nNeuronsX(360/phaseBin) of the average spike
...
if enhaceResBy>1
   neuronFiringPhaseRate=imresize(neuronFiringPhaseRate,[size(neuronFiringPhaseRate,1),enhaceResBy*size(neuronFiringPhaseRate,2)]); 
